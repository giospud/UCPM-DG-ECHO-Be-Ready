...
print("=========================================================================")
print("  ")
print("  Hydrodynamic simulation of La Spezia _ on "+machine)
print("  ")
print("=========================================================================")
print("  ")
...
for k in SC:
   ...
   #@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    #@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    os.system("cp spezia.mdf_Uniformini spezia.mdf_tmp")
    ...
    for i in range(int(Dur/Delt)+1):
        ...
        os.system("cp spezia.mdf_tmp spezia.mdf")
        os.system( "cat spezia.mdf_tmp | sed -i  "+ "'s/Dt     =/Dt     =  "+str(Dt)+"/"+"g'" + " spezia.mdf")
        os.system( "cat spezia.mdf_tmp | sed -i  "+ "'s/Tstart =/Tstart =  "+str("{:.8e}".format(Tstart0))+"/"+"g'" + " spezia.mdf")
        os.system( "cat spezia.mdf_tmp | sed -i  "+ "'s/Tstop  =/Tstop  =  "+str("{:.8e}".format(Tstop0))+"/"+"g'" + " spezia.mdf")
        os.system( "cat spezia.mdf_tmp | sed -i  "+ "'s/Flmap  =/Flmap  =  "+str("{:.8e}".format(Tstart0))+" "+str(Flmap)+"  "+str("{:.8e}".format(Tstop0))+"/"+"g'" + " spezia.mdf")
        os.system( "cat spezia.mdf_tmp | sed -i  "+ "'s/Flhis  =/Flhis  =  "+str("{:.8e}".format(Tstart0))+" "+str(Flhis)+"  "+str("{:.8e}".format(Tstop0))+"/"+"g'" + " spezia.mdf")
        os.system( "cat spezia.mdf_tmp | sed -i  "+ "'s/Flpp   =/Flpp   =  "+str("{:.8e}".format(Tstart0))+" "+str(Flpp)+"  "+str("{:.8e}".format(Tstop0))+"/"+"g'" + " spezia.mdf")
        os.system( "cat spezia.mdf_tmp | sed -i  "+ "'s/Flrst  =/Flrst  =  "+str("{:.1e}".format(Flrst0))+"/"+"g'" + " spezia.mdf")
        os.system( "cat spezia.mdf_tmp | sed -i  "+ "'s/Vicouv =/Vicouv =  "+str("{:.7e}".format(eddyvis))+"/"+"g'" + " spezia.mdf")
        

        print(" Running coupled FLOW_WAVE")
        os.system("rm tri-diag.spezia-* com-spezia-* TMP* td* *irlog* *url* *ddb *DATA*")
        os.system("rm wavm* trim* tri-diag.spezia-* com-spezia-*")
        os.system("./run_flow.sh > " + dir_log + "log_d3d.txt"+ " 2>&1")
       # @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        os.system("mv output/"+a+"/trim-spezia.dat " "output_spezia/"+a+"/trim-spezia_"+"%03d" % (k,)+"_""%05d" % (i)+".dat")
        os.system("mv output/"+a+"/trim-spezia.def " "output/"+a+"/trim-spezia_"+"%03d" % (k,)+"_""%05d" % (i)+".def")

        os.system("mv "+"tri-rst.spezia*"+" tri-rst."+"%05d" % (i))
        os.system("cp spezia.mdf_Restartini spezia.mdf_tmp")
        os.system( "cat spezia.mdf_tmp | sed -i  "+ "'s/Restid =/Restid = "+"#"+"%05d" % (i)+"#"+"/"+"g'" + " spezia.mdf_tmp")
        Flrst0=Flrst
        Delt0=Delt
        Tstart0 =Tstop0
        Tstop0  =Tstop0+Delt
